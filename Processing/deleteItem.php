<?php	
	...
	//echo "$type<br>";
        ...
        //delete the entry from the loans table
	$query = "DELETE FROM Loan WHERE libraryCode = '$item'";
	//echo "$query<br>";
	...
	if(!$results){
        ...
        //delete the entry from the holds table
	$query = "DELETE FROM Hold WHERE libraryCode = '$item'";
	//echo "$query<br>";
	$results = mysql_query($query);
	if(!$results){
            echo "could not delete from $item table<br />";
	...
	// delete the entry from the type table

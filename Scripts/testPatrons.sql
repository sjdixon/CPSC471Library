...
insert into Patron (pAccount, membershipStartDate, membershipExpired, name, phone, address, email) values (60, curdate(), 1, "ExpiredPatron", "403-123-4567", "1001 1st Street NW Calgary", "fake-email@me.com");

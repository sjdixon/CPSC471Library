...
insert into Patron (pAccount, membershipStartDate, membershipExpired, name, phone, address, email) values (60, curdate(), 0, "TestPatron", "403-123-4567", "1001 1st Street NW Calgary", "fake-email@me.com");
...
update Patron set membershipExpiryDate = DATE_ADD(curdate(), INTERVAL 1 YEAR) where pAccount=60 or pAccount=70 or pAccount=80 or pAccount=90;

# Create new Item Information

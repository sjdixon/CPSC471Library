...
<select id="combobox" name="searchType">
...
<script type="text/javascript">
	$("#Search").click(function search(){
		...
		var checkString = document.getElementById("combobox").value;
		...
		xmlreq.open("GET","Processing/search.php?string="+string+"&sType="+checkString,true);
		xmlreq.send();
		});	
	</script>	
</form>	
